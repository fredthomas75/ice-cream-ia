    ...
    <footer className="mt-24 bg-cocoa text-cream">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid gap-12 md:grid-cols-4">
          <div className="md:col-span-2">
            ...
            <p className="mt-4 max-w-md text-cream/70">
              Crème glacée artisanale née d&apos;un atelier d&apos;IA chez Talsom.
              Brassée en petits lots à Montréal. Livrée congelée chez vous.
            </p>
            <p className="mt-6 text-xs text-cream/40">
              © {new Date().getFullYear()} Glacé IA — Tous droits réservés.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/menu" className="text-cream/80 hover:text-berry">Tous les parfums</Link></li>
              <li><Link href="/menu?cat=sorbet" className="text-cream/80 hover:text-berry">Sorbets vegan</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li className="text-cream/80">bonjour@glace-ia.ca</li>
        ...
        <div className="mt-12 border-t border-cream/10 pt-6 text-xs text-cream/40">
          Scaffold généré le jour de l&apos;atelier <em>T&apos;as faim pour l&apos;IA?</em> — Half-Hack Intact Assurance.
        </div>
      </div>
    </footer>
  );
